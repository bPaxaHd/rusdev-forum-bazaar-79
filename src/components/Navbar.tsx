      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6 md:gap-8 lg:gap-10">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link to="/documentation" className="nav-link">Документация</Link>
            <Link to="/career" className="nav-link">Карьера</Link>
            <Link to="/premium" className="nav-link">Премиум</Link>
          </nav>
        </div>
